...
---- A DYNAMIC Huffman Coding Implementation (Algorithm V) ----
	...
	Filename:     VITC.C	(Encoder)
	Decoder:      VITD.C
	Written by:   Gerald Tamayo
	Date:         2005
	
	To compile:   tcc -w vitc.c gtbitio.c huf.c
	              bcc32 -w vitc.c gtbitio.c huf.c
	              g++ -O2 vitc.c gtbitio.c huf.c -s -o vitc
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
